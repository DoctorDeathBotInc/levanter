...
module.exports = {
  ...
  ANTILINK_MSG: process.env.ANTILINK_MSG || '_Antilink Detected &mention evicted_',
  ANTISPAM_MSG: process.env.ANTISPAM_MSG || '_Antispam Detected &mention evicted_',
  ANTIWORDS_MSG: process.env.ANTIWORDS_MSG || '_AntiWord Detected &mention evicted_',
  ...
  ANTI_BOT_MESSAGE: process.env.ANTI_BOT_MESSAGE || '&mention evicted',
  WARN_MESSAGE:
    process.env.WARN_MESSAGE ||
    '⚠️WARNING⚠️\n*User :* &mention\n*Warn :* &warn\n*Remaining :* &remaining',
  WARN_RESET_MESSAGE:
    process.env.WARN_RESET_MESSAGE || `WARN RESET\nUser : &mention\nRemaining : &remaining`,
  WARN_KICK_MESSAGE: process.env.WARN_KICK_MESSAGE || '&mention evicted',
